...
echo '<div class="vertical-menu"></div><a href="/cgi-bin/charger/clear_attached_butler.sh" class="active"><b>Clear attached Butler and blocked butler from Charger</b></a>'
