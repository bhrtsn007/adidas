...
elif [ "$username" = "tac" ] && [ "$password" = "Grey%407890" ]; then
  echo '<div class="vertical-menu"></div><a href="abdadfdafjgjkgvsdf23efsdscs23j891dgz1_TAC/tac_easy_console.sh" class="active"><b>Welcome To Easy Console</b></a>'
